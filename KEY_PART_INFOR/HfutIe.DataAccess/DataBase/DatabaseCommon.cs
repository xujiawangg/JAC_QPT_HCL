...
namespace HfutIe.DataAccess
{
    public class DatabaseCommon
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DbParameter[] GetParameter<T>(DbHelper dbhelper, T entity)
        {
            string pkName = GetKeyField<T>().ToString();//获得实体主键字段
            ...
            foreach (PropertyInfo pi in props)
            {
                if (pi.GetValue(entity, null) != null)
                {
                    ...
                    parameter.Add(DbFactory.CreateDbParameter(dbhelper, dbhelper.DbParmChar + pi.Name, pi.GetValue(entity, null), dbtype));
                }
            }
            foreach (PropertyInfo pi in props)
            {
                if (pi.GetValue(entity, null) != null && pkName == pi.Name)
                {
                    switch (pi.PropertyType.ToString())
                    {
                        case "System.Nullable`1[System.Int32]":
        ...
        /// </summary>
        /// <returns></returns>
        public static DbParameter[] GetParameter(DbHelper dbhelper, Hashtable ht)
        {
            IList<DbParameter> parameter = new List<DbParameter>();
            DbType dbtype = new DbType();
            foreach (string key in ht.Keys)
            {
                if (ht[key] is DateTime)
                    ...
                    dbtype = DbType.String;
                parameter.Add(DbFactory.CreateDbParameter(dbhelper, dbhelper.DbParmChar + key, ht[key], dbtype));
            }
            return parameter.ToArray();
        }
        #endregion
        ...
        /// <returns></returns>
        public static string FormatSQL(DbHelper dbhelper, string strsql)
        {
        ...
        /// <returns>int</returns>
        public static StringBuilder InsertSql(DbHelper dbhelper, string tableName, Hashtable ht)
        {
        ...
        /// <param name="entity">实体类</param>
        /// <returns>int</returns>
        public static StringBuilder InsertSql<T>(DbHelper dbhelper, T entity)
        {
            Type type = entity.GetType();
            StringBuilder sb = new StringBuilder();
            sb.Append(" Insert Into ");
        ...
        /// <param name="entity">实体类</param>
        /// <returns>int</returns>
        public static StringBuilder InsertSql<T>(DbHelper dbhelper, T entity,string tablename)
        {
            Type type = entity.GetType();
            StringBuilder sb = new StringBuilder();
            sb.Append(" Insert Into ");
        ...
        /// <returns></returns>
        public static StringBuilder UpdateSql(DbHelper dbhelper, string tableName, Hashtable ht, string pkName)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(" Update ");
            sb.Append(tableName);
        ...
        /// <param name="pkName">主键</param>
        /// <returns>int</returns>
        public static StringBuilder UpdateSql<T>(DbHelper dbhelper, T entity, string pkName)
        {
            Type type = entity.GetType();
            PropertyInfo[] props = type.GetProperties();
            StringBuilder sb = new StringBuilder();
        ...
        /// <param name="entity">实体类</param>
        /// <returns>int</returns>
        public static StringBuilder UpdateSql<T>(DbHelper dbhelper, T entity)
        {
        ...
        /// <returns></returns>
        public static StringBuilder DeleteSql(DbHelper dbhelper, string tableName, string pkName)
        {
        ...
        /// <returns></returns>
        public static StringBuilder DeleteSql(DbHelper dbhelper, string tableName, Hashtable ht)
        {
        ...
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        public static StringBuilder DeleteSql<T>(DbHelper dbhelper, T entity)
        {
            Type type = entity.GetType();
            PropertyInfo[] props = type.GetProperties();
