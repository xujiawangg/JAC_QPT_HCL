...
namespace HfutIe
{
    public abstract class DbHelperSQL
    {
        ...
        //实验室DCT数据库连接（本机）
        public static string sql_server_name_HCL = "192.168.10.58";
        public static string sql_database_name_HCL = "JAC_QPT_HCL";
        public static string sql_username_HCL = "sa";
        public static string sql_password_HCL = "sa12345";
        public DbHelperSQL()
        {
        }
        /// <summary>
        ...
        {
            connectionString = "server = " + sql_server_name_HCL + ";database = " + sql_database_name_HCL + ";user id = " + sql_username_HCL + ";password=" + sql_password_HCL + "";
        }
        #region 公用方法
