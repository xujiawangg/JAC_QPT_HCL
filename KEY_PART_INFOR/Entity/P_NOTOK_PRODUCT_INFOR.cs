...
namespace HfutIE.Entity
{
    ...
    /// <author>
    ///		<name>she</name>
    ///		<date>2018.12.12 10:04</date>
    /// </author>
    /// </summary>
    [Description("不合格产品信息表")]
    [PrimaryKey("P_NOTOK_PRO_INFOR_KEY")]
    public class P_NOTOK_PRODUCT_INFOR : BaseEntity
    {
        ...
        /// <returns></returns>
        [DisplayName("闲置时间")]
        public DateTime? HANGON_TIME { get; set; }
        /// <summary>
        /// 备注
        /// </summary>
        /// <returns></returns>
        ...
        public override void Create()
        {
            ...
            this.ACCOUNT_CODE = SystemLog.UserCode;//当前用户编号
            this.ACCOUNT_NAME = SystemLog.UserName;//当前用户姓名
        }
        /// <summary>
        /// 编辑调用
        /// </summary>
