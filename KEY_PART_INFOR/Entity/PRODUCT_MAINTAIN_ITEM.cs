...
namespace HfutIE.Entity
{
    ...
    /// <author>
    ///		<name>she</name>
    ///		<date>2019.01.18 19:39</date>
    /// </author>
    /// </summary>
    [Description("产品排故项")]
    [PrimaryKey("PRODUCT_MAINTAIN_ITEM_KEY")]
    public class PRODUCT_MAINTAIN_ITEM : BaseEntity
    {
        #region 获取/设置 字段值
        /// <summary>
        /// key
        ...
        {
            this.PRODUCT_MAINTAIN_ITEM_KEY = CommonHelper.GetGuid;
        ...
        {
            this.PRODUCT_MAINTAIN_ITEM_KEY = KeyValue;
