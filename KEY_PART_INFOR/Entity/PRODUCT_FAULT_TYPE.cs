...
namespace HfutIE.Entity
{
    ...
    /// <author>
    ///		<name>she</name>
    ///		<date>2019.01.18 19:40</date>
    /// </author>
    /// </summary>
    [Description("产品故障类型")]
    [PrimaryKey("PRODUCT_FAULT_TYPE_KEY")]
    public class PRODUCT_FAULT_TYPE : BaseEntity
    {
        #region 获取/设置 字段值
        /// <summary>
        /// key
        ...
        /// </summary>
        /// <returns></returns>
        [DisplayName("产品故障类型描述")]
        public string DISCRIBE { get; set; }
        /// <summary>
        /// 父级产品故障类型key
        /// </summary>
        /// <returns></returns>
        [DisplayName("父级产品故障类型key")]
        public string PARENTID { get; set; }
        /// <summary>
        /// 父级产品故障类型名称
        /// </summary>
        /// <returns></returns>
        [DisplayName("父级产品故障类型名称")]
        ...
        {
            this.PRODUCT_FAULT_TYPE_KEY = CommonHelper.GetGuid;
        ...
        {
            this.PRODUCT_FAULT_TYPE_KEY = KeyValue;
